...
n.uktb_year/(pop_year*0.3)

# 'life time' risk in UK tb of those 'detectable'
n.uktb_year/(pop_year*0.3*case_detection_rate)

# life time risk in UK and exit tb
(n.uktb_year + n.exit_tb)/(pop_year*0.3)

# life time risk in UK and exit tb of those 'detectable'
(n.uktb_year + n.exit_tb)/(pop_year*0.3*case_detection_rate)
