...
# 2016
#
# read-in from STATA and create a data dictionary


# read-in without labels but with correct date format
IMPUTED_IOM_ETS_WHO_merged_15_2_9 <- readstata13::read.dta13(file="T:\\incidence data\\IMPUTED--IOM_ETS_WHO_merged_15_2_9.dta", convert.dates = TRUE)
...
save(IMPUTED_IOM_ETS_WHO_merged_15_2_9, file="T:/incidence data/IMPUTED_IOM_ETS_WHO_merged_15_2_9.RData")
save(IMPUTED_sample, file="sample_IMPUTED--IOM_ETS_WHO_merged.RData")


# read-in with labels with dates as numeric
IMPUTED_IOM_ETS_WHO_merged_15_2_9 <- haven::read_dta("T:\\incidence data\\IMPUTED--IOM_ETS_WHO_merged_15_2_9.dta")
