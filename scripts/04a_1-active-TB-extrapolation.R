...
suth3 <- suth[seq(1,length(suth), by = 2)]
suth3 <- c(suth3, rep(tail(suth3,1), length(suth) - length(suth3) + 1))
...
# lines(seq(0, length(p_incid_year3 + 1)), c(0,p_incid_year3), type = 'l', lty = 3, col = "blue", lwd = 2)
