...
load(here::here("output", "plots", "QFT-plus", "runs_1.1", "policy_001", "ceac.RData"))
load(here::here("output", "plots", "QFT-plus", "runs_1.1", "policy_001", "CE_plane.RData"))
load(here::here("output", "plots", "QFT-plus", "runs_1.1", "policy_001", "INMB_boxplot.RData"))
load(here::here("output", "plots", "QFT-plus", "runs_1.1", "policy_001", "ridgeplot.RData"))
...
p <-
  grid.arrange(ceac + labs(subtitle = "A") + theme(text = element_text(size = 15)),
               ...
               ridgeplot + labs(subtitle = "D") + theme(text = element_text(size = 15)),
               nrow = 2)
p

ggplot2::ggsave(file = here::here("output", "plots", "manuscript grid of plots QFTplus.png"),
                plot = p,
