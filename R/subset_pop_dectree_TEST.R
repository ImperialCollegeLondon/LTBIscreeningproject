...
#' Subset populations of decision tree TEST
#'
#' THIS FUNCTION IS SLOW BUT CAN BE USED TO TEST
#' AGAINST ALTERNATIVE VERSION subset_pop_dectree.
#'
...
#' @examples
#'
subset_pop_dectree_TEST <- function(osNode) {
