...
# input values
## full-factorial grid
pred_data_20000 <- pred_data_30000 <-
...
# scenario_parameter_p <- readxl::read_excel("data/scenario-parameter-values_fullfactorial.xlsx", sheet = "p")
#
# pred_data <-
...
ggsave(file = filename, g, width = 30, height = 20, units = "cm")
